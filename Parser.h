...
pr = FloatToStr(translation_file(obj.Get_element(), ss, file_name, accuracy)) ;
...
pr = FloatToStr(translation(obj.Get_element(), ss, accuracy));
...
//cout « count_action « ' ' « translation(n1, ss, file_name, accuracy) « " - " « translation(n2, ss, file_name, accuracy) « " = "
//<< s << endl;
count_action++;
}
break;
...
ShowMessage("\t\t\tОшибка.\n Слишком большое число. \t\tНажмите \"OK\" и введите корректное выражение заново.");
return 0;
